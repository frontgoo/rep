package org.frontgoo.orm.hibernate.dao;
...
@Repository
@Transactional
public class IHibernateDao<T, PK extends Serializable> {
    ...
    public IHibernateDao(SessionFactory sessionFactory, Class<T> entityClass) {  
